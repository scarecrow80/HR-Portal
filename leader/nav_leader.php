<div id="navcontainer" class="fullsizeBlock">
    ...
    <ul id="Nav">
        ...
        <li class=" " id="fyzs_" role="presentation">
            <a class="list" onclick="window.location='../HR-Portal/logout.php'" id="" role="menuitem" title="Logg ut" style="cursor: pointer"> <span class="nav-item-label"> Logg ut</span> </a>
        </li>
